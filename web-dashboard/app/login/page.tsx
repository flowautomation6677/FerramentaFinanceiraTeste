            ...
            <div className="flex w-full items-center justify-center p-4 lg:w-1/2 bg-[#020617]">
                <div className="w-full max-w-md space-y-8">
                    ...
                    >
                        ...
                        <button className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/5 py-3 text-sm font-medium text-white transition hover:bg-white/10">
